...
export const UserComponet = () => {
  ...
  const { handleUpdateUser, handleUpdatePassword, loading } =
  ...
  const handleSubmit = async () => {
    if (
      ...
      toast.error("Todos los campos de perfil son obligatorios.");
      return;
    }
  ...
  const handlePasswordSubmit = async () => {
    if (!passwordData.passwordOld || !passwordData.passwordNew) {
      toast.error("Ambos campos de contraseña son obligatorios.");
      return;
    }
    if (passwordData.passwordNew.length < 10) {
      ...
      >
        ...
        >
          ...
          <Text>
            ...
            {user.direction || "No especificada"}
          </Text>
          <Text>
            <Text as="span" fontWeight="semibold">
              Teléfono:
          ...
          <Text>
            ...
            {user.work || "No especificado"}
          </Text>
          <Text>
            <Text as="span" fontWeight="semibold">
              Ingreso mensual:
            </Text>{" "}
            Q{parseFloat(user.income).toFixed(2) || "0.00"}
          </Text>
          <Text>
            <Text as="span" fontWeight="semibold">
              Cuenta:
          ...
          <Text>
            ...
            <Badge
              colorScheme={badgeColorScheme[user.role] || "gray"}
              borderRadius="md"
              px={2}
              py={1}
            >
          ...
          <Text>
            ...
            <Badge
              colorScheme={badgeColorScheme[user.typeAccount] || "gray"}
              borderRadius="md"
              px={2}
              py={1}
            >
          ...
          >
            Miembro desde:{" "}
            {format(new Date(user.createdAt), "PPP - hh:mm a", { locale: es })}
          </Text>
        </Stack>
      </Box>
        ...
        <ModalContent bg={modalBg} borderRadius="xl" boxShadow="2xl">
          ...
          <ModalBody py={6}>
            <VStack spacing={5}>
              ...
              <Heading size="sm" color={headingColor} alignSelf="flex-start">
                Cambiar Contraseña
              </Heading>
              <FormControl isRequired>
              ...
              <FormControl isRequired>
                ...
                />
                {passwordData.passwordNew.length > 0 &&
                  passwordData.passwordNew.length < 10 && (
